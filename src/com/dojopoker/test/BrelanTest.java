...
public class BrelanTest {
    ...
    public void brelanVsCarteHauteTest() {
        ...
        Assert.assertEquals(new Gagnant(1, VictoiresPossibles.brelan, new Integer[] {1}), ComparateurMain.compare(main1, main2));
        Assert.assertEquals(new Gagnant(2, VictoiresPossibles.brelan, new Integer[] {1}), ComparateurMain.compare(main2, main1));
    }
    ...
    public void brelanEgaliteTest() {
        ...
        Assert.assertEquals(new Gagnant(2, VictoiresPossibles.carte_la_plus_haute, new Integer[]{5}), ComparateurMain.compare(main3, main4));
        Assert.assertEquals(new Gagnant(1, VictoiresPossibles.carte_la_plus_haute, new Integer[]{5}), ComparateurMain.compare(main4, main3));
        ...
        Assert.assertEquals(new Gagnant(1, VictoiresPossibles.brelan, new Integer[] {5}), ComparateurMain.compare(main5, main6));
        Assert.assertEquals(new Gagnant(2, VictoiresPossibles.brelan, new Integer[] {5}), ComparateurMain.compare(main6, main5));
        ...
        Assert.assertEquals(new Gagnant(1, VictoiresPossibles.carte_la_plus_haute, new Integer[] {5}), ComparateurMain.compare(main9, main10));
        Assert.assertEquals(new Gagnant(2, VictoiresPossibles.carte_la_plus_haute, new Integer[] {5}), ComparateurMain.compare(main10, main9));
    }
}